...
<head>
    ...
    .hero {
        position: relative;
        background: url("./public/assets/images/exam-bg.png") center/cover no-repeat;
        height: 100vh;
        display: flex;
        align-items: center;
        text-align: center;
...
<body>
    ...
    <section class="hero">
        ...
        <div class="container">
            ...
            <?php if ($user): ?>
            <a href="./public/dashboard.php" class="btn btn-light btn-lg px-4">Go to Dashboard</a>
            <?php else: ?>
            <a href="./public/login.php" class="btn btn-warning btn-lg px-4 me-2">Login</a>
            <a href="./public/register.php" class="btn btn-light btn-lg px-4">Register</a>
            <?php endif; ?>
        </div>
    </section>
